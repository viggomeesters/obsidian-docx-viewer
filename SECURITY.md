...
- It does not write back to the source document.
- It does not launch external viewers.

Report security issues through GitHub security advisories or a private issue with reproduction details.
